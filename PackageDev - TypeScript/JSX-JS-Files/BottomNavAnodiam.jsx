...
const BottomNavAnodiam = (props) => {
 ...
 // useEffect to STOP back button press
  useEffect(() => {
  ...
  // Bottom Nav Tabs related props & validations
  ...
  validation.validateProps(fileName, { activeColor, greyColor, backgroundColor, rippleColor,
                                       fontFamily, fontSize, fontWeight, padding, iconSize, bottomNavHeight})
  // icons and their validations
  const renderIcon = (iconType, iconProps) => {
    switch (iconType) {
      ...
      default:
        validation.raiseIssue('Warning', fileName, 'iconType', `${iconType}`, `one of the supported icon families among the following: 'MaterialIcons', 'Ionicons', 'FontAwesome', 'FontAwesome5', 'MaterialCommunityIcons', 'Entypo', 'EvilIcons', 'Feather', 'AntDesign', 'Octicons', 'SimpleLineIcons', 'Zocial', 'Foundation'. Defaulting to <MaterialCommunityIcons name='unicorn'/>`)}
