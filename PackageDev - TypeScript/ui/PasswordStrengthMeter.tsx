...
const PasswordStrengthMeter: React.FC<PasswordStrengthMeterProps> = (props) => {
  ...
  // If passwordStrength is default (empty), render nothing
  ...
  return (
    <View style={styles.passwordMeterContainer}>
      <Progress.Bar
        ...
        height={styles.progressBar.height as number}
        borderRadius={styles.progressBar.borderRadius as number}
        color={color}
        unfilledColor={styles.progressBar.unfilledColor}
        style={styles.progressBarStyle}
        borderWidth={styles.progressBar.borderWidth as number}
      />
    </View>
  );
};
