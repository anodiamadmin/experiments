import BottomNavAnodiam from '../../ui/BottomNavAnodiam';

export default function TabLayout() {
  return (
    <BottomNavAnodiam />
    // <BottomNavAnodiam tabs={[{ name: 'SocialMedia', label: 'Social Media', icon: 'video-image', iconType: 'MaterialCommunityIcons' },
